...
namespace WinFormUI
{
    public partial class UC_ImageButton : UserControl
    {
        private Image _imageFlag = null;
        private string _displayText = "";
        private bool _bSelected = false;
        private Color _colorBg = System.Drawing.SystemColors.Control;

        //public event MouseEventHandler _LeftOneClick;

        public UC_ImageButton()
        {
            InitializeComponent();
        }
        public UC_ImageButton(Image imageFlag, string displayText)
        {
            InitializeComponent();
                ...
                { 
                    ...
                    if (_bSelected)
                        this.tableLayoutPanel_R.BackColor = System.Drawing.SystemColors.ControlDark;
                            //System.Drawing.SystemColors.Control;//Color.Yellow;
                    //.CellBorderStyle = System.Windows.Forms.TableLayoutPanelCellBorderStyle.Single;
                    else
                        this.tableLayoutPanel_R.BackColor = _colorBg;
        ...
        {
            tableLayoutPanel_R.BackColor = bgColor;
